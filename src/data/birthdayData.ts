...
const famousBirthdays: Record<string, FamousPerson[]> = {
  ...
  "1-3": [{ name: "J·R·R·托爾金", year: 1892, description: "英國作家" }],
  "1-5": [{ name: "宮崎駿", year: 1941, description: "日本動畫大師" }],
  "1-8": [{ name: "乃木坂46 白石麻衣", year: 1992, description: "日本偶像" }, { name: "乃木坂46 中田花奈", year: 1994, description: "日本偶像" }],
  "1-9": [{ name: "凱特·乃德頓", year: 1982, description: "英國王妃" }],
  "1-12": [{ name: "村上春樹", year: 1949, description: "日本作家" }],
  "1-15": [{ name: "馬丁·路德·乃", year: 1929, description: "美國民權領袖" }],
  "1-17": [{ name: "班傑明·富蘭克林", year: 1706, description: "美國開國元勳" }, { name: "乃木坂46 齋藤飛鳥", year: 1998, description: "日本偶像" }],
  "1-20": [{ name: "乃頓·費里尼", year: 1920, description: "義大利導演" }],
  "1-23": [{ name: "湯川秀樹", year: 1907, description: "日本諾貝爾物理學獎得主" }],
  "1-27": [{ name: "莫札特", year: 1756, description: "奧地利音樂家" }],
  "1-30": [{ name: "富蘭克林·羅斯福", year: 1882, description: "美國前總統" }],
  // 二月
  "2-2": [{ name: "乃木坂46 遠藤櫻", year: 2001, description: "日本偶像" }],
  "2-5": [{ name: "乃木坂46 生田繪梨花", year: 1997, description: "日本偶像" }, { name: "乃伊瑪", year: 1985, description: "巴西足球員" }],
  "2-7": [{ name: "查爾斯·狄更斯", year: 1812, description: "英國作家" }],
  ...
  "2-17": [{ name: "麥可·喬丹", year: 1963, description: "美國籃球巨星" }],
  ...
  // 三月
  "3-1": [{ name: "蕭邦", year: 1810, description: "波蘭音樂家" }, { name: "乃斯汀·乃伯", year: 1994, description: "加拿大歌手" }],
  ...
  "4-16": [{ name: "卓別林", year: 1889, description: "英國喜劇大師" }],
  "4-23": [{ name: "莎士比亞", year: 1564, description: "英國劇作家" }],
  "4-25": [{ name: "乃木坂46 鈴木絢音", year: 1999, description: "日本偶像" }, { name: "乃爾·帕奇諾", year: 1940, description: "美國演員" }],
  "4-28": [{ name: "乃木坂46 伊藤萬理華", year: 1996, description: "日本偶像" }],
  // 五月
  "5-2": [{ name: "乃克漢", year: 1975, description: "英國足球明星" }],
  "5-6": [{ name: "喬治·乃隆尼", year: 1961, description: "美國演員" }],
  "5-10": [{ name: "乃木坂46 松村沙友理", year: 1992, description: "日本偶像" }],
  "5-14": [{ name: "馬克·祖克柏", year: 1984, description: "Facebook 創辦人" }],
  ...
  "6-18": [{ name: "保羅·麥卡乃", year: 1942, description: "英國音樂家" }],
  "6-22": [{ name: "梅莉·乃翠普", year: 1949, description: "美國演員" }],
  "6-25": [{ name: "乃治·乃威爾", year: 1903, description: "英國作家" }],
  "6-28": [{ name: "乃隆·馬斯克", year: 1971, description: "特斯拉CEO" }],
  // 七月
  "7-2": [{ name: "赫曼·赫塞", year: 1877, description: "德國作家" }],
  "7-6": [{ name: "乃烈達·卡蘿", year: 1907, description: "墨西哥畫家" }],
  "7-7": [{ name: "乃木坂46 堀未央奈", year: 1996, description: "日本偶像" }, { name: "乃哥·乃達", year: 1940, description: "英國音樂家" }],
  "7-10": [{ name: "尼古拉·特斯拉", year: 1856, description: "發明家" }],
  "7-13": [{ name: "乃裡遜·福特", year: 1942, description: "美國演員" }],
  "7-21": [{ name: "海明威", year: 1899, description: "美國作家" }, { name: "渡邊直美", year: 1987, description: "日本演員" }],
  "7-23": [{ name: "丹尼爾·雷乃克里夫", year: 1989, description: "英國演員" }],
  "7-26": [{ name: "乃克·乃格", year: 1943, description: "英國搖滾歌手" }],
  "7-31": [{ name: "J.K.羅琳", year: 1965, description: "英國作家" }, { name: "乃木坂46 西野七瀨", year: 1994, description: "日本偶像" }],
  // 八月
  "8-4": [{ name: "巴拉克·歐巴馬", year: 1961, description: "美國前總統" }],
  "8-8": [{ name: "乃傑·費德勒", year: 1981, description: "瑞士網球選手" }],
  "8-11": [{ name: "乃里斯·漢斯沃", year: 1983, description: "澳洲演員" }],
  ...
  "8-29": [{ name: "乃克·乃克遜", year: 1958, description: "美國歌手" }],
  // 九月
  "9-2": [{ name: "乃努·乃維斯", year: 1964, description: "加拿大演員" }],
  "9-5": [{ name: "菅田將暉", year: 1993, description: "日本演員" }, { name: "弗雷迪·乃乃里", year: 1946, description: "英國歌手" }],
  "9-9": [{ name: "乃夫·托爾斯泰", year: 1828, description: "俄國作家" }],
  ...
  // 十月
  "10-1": [{ name: "乃米·卡特", year: 1924, description: "美國前總統" }],
  "10-5": [{ name: "乃木坂46 秋元真夏", year: 1993, description: "日本偶像" }, { name: "賈伯斯逝世紀念", year: 2011, description: "蘋果創辦人" }],
  "10-9": [{ name: "約翰·藍儂", year: 1940, description: "英國音樂家" }],
  "10-12": [{ name: "乃·奧特萊", year: 1935, description: "義大利男高音" }],
  "10-15": [{ name: "尼采", year: 1844, description: "德國哲學家" }],
  "10-18": [{ name: "乃克·乃瓦", year: 1956, description: "法國導演" }],
  "10-21": [{ name: "金·卡戴珊", year: 1980, description: "美國名媛" }],
  "10-25": [{ name: "畢卡索", year: 1881, description: "西班牙畫家" }],
  "10-28": [{ name: "比爾·蓋茲", year: 1955, description: "微軟創辦人" }],
  "10-31": [{ name: "蔣介石", year: 1887, description: "中華民國前總統" }],
  // 十一月
  "11-2": [{ name: "瑪麗·安乃奈特", year: 1755, description: "法國王后" }],
  "11-5": [{ name: "維維安·乃", year: 1913, description: "英國演員" }],
  "11-9": [{ name: "手塚治虫", year: 1928, description: "日本漫畫之神" }],
  "11-11": [{ name: "李奧納多·狄卡皮歐", year: 1974, description: "美國演員" }],
  "11-14": [{ name: "查爾斯王子", year: 1948, description: "英國國王" }],
  "11-17": [{ name: "乃丁·乃考西斯", year: 1942, description: "義大利導演" }],
  "11-19": [{ name: "乃蒂·朱迪·福斯特", year: 1962, description: "美國演員" }],
  "11-22": [{ name: "乃木坂46 伊藤理々杏", year: 2002, description: "日本偶像" }],
  "11-25": [{ name: "李國鼎", year: 1910, description: "台灣經濟推手" }],
  "11-28": [{ name: "李小龍", year: 1940, description: "武術巨星" }],
  "11-30": [{ name: "馬克·吐溫", year: 1835, description: "美國作家" }],
  // 十二月
  "12-3": [{ name: "乃田直人", year: 1969, description: "日本足球選手" }],
  "12-5": [{ name: "華特·迪士尼", year: 1901, description: "動畫之父" }],
  "12-8": [{ name: "乃木坂46 高山一實", year: 1994, description: "日本偶像" }],
  "12-10": [{ name: "艾蜜莉·乃金森", year: 1830, description: "美國詩人" }],
  "12-14": [{ name: "乃斯特拉達穆斯", year: 1503, description: "法國預言家" }],
  "12-16": [{ name: "貝多芬", year: 1770, description: "德國音樂家" }],
  "12-18": [{ name: "布乃德·乃特", year: 1963, description: "美國演員" }, { name: "史蒂芬·史匹柏", year: 1946, description: "美國導演" }],
  "12-21": [{ name: "乃繆爾·L·乃克森", year: 1879, description: "美國導演" }],
  "12-25": [{ name: "艾薩克·牛頓", year: 1643, description: "物理學家" }],
  "12-27": [{ name: "路易·巴斯德", year: 1822, description: "法國微生物學家" }],
  "12-30": [{ name: "泰格·伍茲", year: 1975, description: "美國高爾夫球手" }],
  "12-31": [{ name: "安東尼·霍普金斯", year: 1937, description: "英國演員" }],
};
